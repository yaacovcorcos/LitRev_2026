...
import { ChatComposerPendingApprovalBar } from "../ChatComposerPendingApprovalBar";
import { getValidPendingApprovalArtifacts, useChatPendingApprovalBarState } from "../useChatPendingApprovalBarState";
...
describe("useChatPendingApprovalBarState", () => {
  it("hides the bar when fewer than 2 valid proposals remain", () => {
    const { result } = renderHook(() => useChatPendingApprovalBarState({
  ...
  it("hides the idle bar while the host is still loading or showing active progress", () => {
    ...
    const { result, rerender } = renderHook(
      ({ isLoading, hasActiveProgress }) => useChatPendingApprovalBarState({
        timeline,
        conversationId: "conv-1",
        isLoading,
        hasActiveProgress,
...
describe("ChatComposerPendingApprovalBar", () => {
