...
import styles from "./ChatComposerQueuedFollowUpBar.module.css";

export type ChatComposerQueuedFollowUpBarProps = {
...
export function ChatComposerQueuedFollowUpBar({
    queuedFollowUp = null,
    onEdit,
    onRemove,
    stackPosition = "top",
}: ChatComposerQueuedFollowUpBarProps) {
