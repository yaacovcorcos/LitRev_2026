    ...
    return messages.map((msg) => {
        ...
        if (msg.userInputRequest) {
            return {
                ...
                questionId: msg.userInputRequest.questionId,
                ...
                decisionRequest: msg.userInputRequest.decisionRequest,
        ...
        case "user_input_required": {
            ...
            return [
                ...timeline,
                {
                    ...
                    header: req.header,
                    context: req.context,
                    decisionBoundaryKey: req.decisionBoundaryKey,
                    recommendedAnswer: req.recommendedAnswer,
                    recommendedReason: req.recommendedReason,
                    decisionRequest: req.decisionRequest,
                    answered: false,
                    createdAt: new Date().toISOString(),
                },
            ];
