...
import styles from "./ComposerPendingApprovalBar.module.css";

export type ComposerPendingApprovalBarProps = {
    pendingCount: number;
...
export function ComposerPendingApprovalBar({
    pendingCount,
    state,
    progress,
    resultText,
    ...
    onStop,
    stackPosition = "top",
}: ComposerPendingApprovalBarProps) {
    return (
