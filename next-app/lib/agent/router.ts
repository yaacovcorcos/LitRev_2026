...
export const AGENT_MODE_CONFIG: Record<AgentMode, AgentModeConfig> = {
    ...
    screening: { systemPromptKey: "screening", allowedTools: ["bulk_screening", "exclude_study", "delete_study", "fetch_open_pdf", "extract_pdf", "read_study_content", "update_study", "store_memory", "forget_memory", "inspect_memory", "ask_user"], memoryScope: "study", description: "Evaluating studies" },
    ...
    qa: { systemPromptKey: "qa", allowedTools: ["search_pubmed", "search_semantic_scholar", "fetch_open_pdf", "read_study_content", "read_protocol", "read_ledger", "update_study", "store_memory", "forget_memory", "inspect_memory", "ask_user"], memoryScope: "project", description: "Checking citations" },
