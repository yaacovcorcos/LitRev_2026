...
export type RuntimeStreamEvent =
  ...
  | ({
      ...
      actualReasoningEffort?: AIStreamChunk["actualReasoningEffort"];
      actualDeliveryMode?: AIStreamChunk["actualDeliveryMode"];
      stopReason?: string;
...
export function normalizeStreamChunk(chunk: AIStreamChunk): RuntimeStreamEvent | null {
  ...
  switch (chunk.type) {
    ...
    case "user_input_required":
      if (!chunk.userInputRequest) return null;
      return {
  ...
  switch (event.type) {
    ...
    case "run_end":
      return {
        ...
        actualDeliveryMode: event.actualDeliveryMode,
