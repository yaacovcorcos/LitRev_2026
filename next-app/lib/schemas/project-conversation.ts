...
export const projectConversationPanelStateSchema = z.object({
    width: z.number(),
    collapsed: z.boolean(),
});

export const projectConversationMessageSchema = z.object({
    id: z.string(),
...
export const projectConversationStateSchema = z.object({
    version: z.literal(1),
    panel: projectConversationPanelStateSchema,
    messages: z.array(projectConversationMessageSchema),
});
