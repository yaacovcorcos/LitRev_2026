...
function LoginContent() {
  ...
  return (
    <main className={styles.shell}>
      <div className={styles.grainOverlay} />
      <section className={styles.content} aria-label="Sign in">
        <header className={styles.logoBlock}>
          <div className={styles.logoMark} aria-hidden="true">
            <svg viewBox="0 0 48 48" className={styles.logoSvg} fill="none">
              <path
          ...
          <div className={styles.socialRow}>
            ...
            {devQuickLoginEnabled ? (
              ...
              >
                ...
                {busyQuickAccess ? "Signing in..." : "Dev mode"}
              </button>
            ) : null}
          </div>
        ...
        <p className={styles.footer}>
          ...
          <button type="button" className={styles.footerCreateOne} disabled aria-disabled="true">
            Create one
          </button>
        </p>
      </section>
