...
type UseProjectConversationBootstrapOptions = {
    projectId: string;
    ...
    setState: Dispatch<SetStateAction<ProjectConversationState>>;
    setIsLoadingConversations: Dispatch<SetStateAction<boolean>>;
};

export function useProjectConversationBootstrap({
    projectId,
    routeConversationId,
...
}: UseProjectConversationBootstrapOptions) {
    useEffect(() => {
        let isActive = true;
