...
import { useCopilotConversationBootstrap } from "../useCopilotConversationBootstrap";
import { syncConversationSelection } from "../useCopilotConversations";
...
describe("project conversation bootstrap", () => {
    ...
    it("does not auto-select when the first send has already claimed a conversation id before bootstrap resolves", async () => {
        ...
        renderHook(() => useCopilotConversationBootstrap({
            projectId: "project-1",
