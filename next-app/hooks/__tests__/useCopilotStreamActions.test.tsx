...
import { createDefaultProjectCopilotState, type ProjectCopilotState } from "@/lib/projectCopilotStorage";
import type { ArtifactData } from "@/types/artifacts";
import type { ChoiceOption, StreamPhase, UserInputRequest } from "@/types/ai";
import type { PendingAttachment } from "@/types/copilot-context";
...
import { useCopilotStreamActions } from "../useCopilotStreamActions";
...
function useHarness() {
    ...
    const hook = useCopilotStreamActions({
        projectId: "project-1",
        updateState: (updater) => {
            setState((prev) => {
...
describe("useCopilotStreamActions artifact review path", () => {
