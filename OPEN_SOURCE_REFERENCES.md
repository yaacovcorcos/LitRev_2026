...
|---|---|---|
| [openai/codex](https://github.com/openai/codex) | Interaction and testing-execution reference for structured user-input flows, local test-lane ergonomics, and reusable skill/request patterns | `docs/design/agent-decision-system.md`; `docs/plans/plan-testing-execution.md`; `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
...
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | Optional runtime comparison input for pause/resume, durable execution, and explicit state-transition ideas | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md`; `docs/reviews/2026-05-06-agent-runtime-reliability-closeout.md` |
| [OpenHands/OpenHands](https://github.com/OpenHands/OpenHands) | Optional runtime comparison input for preserving useful intermediate work across interruptions | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
| [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) | Optional runtime comparison input for typed tool/result boundaries, structured failures, and durable execution posture | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md`; `docs/reviews/2026-05-06-agent-runtime-reliability-closeout.md` |
| [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | Optional runtime comparison input for tool and handoff ergonomics, guardrails, and traceable sessions | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
| [letta-ai/letta](https://github.com/letta-ai/letta) | Optional secondary runtime comparison input for workflow/state ideas | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
| [mastra-ai/mastra](https://github.com/mastra-ai/mastra) | Optional secondary runtime comparison input for workflow/state ideas | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
| [microsoft/autogen](https://github.com/microsoft/autogen) | Optional secondary runtime comparison input for workflow/state ideas | `docs/reviews/2026-04-16-agentic-open-source-benchmark.md` |
