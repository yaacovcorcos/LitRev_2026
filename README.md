...
- Prefer first-principles, root-cause fixes over surface patches. Do the hard work when needed, including redesign, rather than stacking brittle band-aids that hide the real problem.
