...
| Agent orchestration and execution loop | `docs/plans/plan-agentic.md`, `docs/plans/plan-agent-quality.md`; use `docs/plans/README.md` to locate any supporting runtime notes; if baseline rescue context matters, start from `docs/plans/plan-agentic.md` and follow only the supporting notes it still points to; `next-app/lib/agent/**`, `next-app/lib/server/agent/**` | Changes to planner/execution/router/sub-agent flow; use only active plans listed in `docs/plans/README.md` |
