...
| Agent orchestration and execution loop | `docs/plans/plan-agentic.md`, `next-app/lib/agent/**`, `next-app/lib/server/agent/**` | Changes to planner/execution/router/sub-agent flow |
