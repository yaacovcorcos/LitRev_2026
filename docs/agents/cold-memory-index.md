...
| Agent orchestration and execution loop | `docs/plans/plan-agentic.md`, `docs/plans/plan-agent-quality.md`; use `docs/plans/README.md` to locate any supporting runtime notes; use `docs/plans/agent-runtime-remediation/plan-fix-012-baseline-stability.md` when the work is part of baseline rescue; `next-app/lib/agent/**`, `next-app/lib/server/agent/**` | Changes to planner/execution/router/sub-agent flow; use only active plans listed in `docs/plans/README.md` |
