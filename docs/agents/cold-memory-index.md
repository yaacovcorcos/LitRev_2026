...
| Chat runtime rollout operations | `docs/plans/chatRuntime.md`, `docs/runbooks/chat-runtime-burn-in.md` | U1.6 canary setup, burn-in validation, and U3 unlock decisions |
