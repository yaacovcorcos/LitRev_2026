...
| Cross-cutting testing strategy and test-scope decisions | `docs/agents/testing-agent-contract.md`, `docs/plans/plan-lint-governance.md`, `docs/reviews/repo-health.md` | Any request to decide what tests to add, evaluate regression-proof coverage, define test strategy, or review whether a change is well tested |
