...
| Agent orchestration and execution loop | `docs/plans/plan-agentic.md`; use `docs/plans/README.md` to locate any additional active runtime plans or supporting remediation detail; `next-app/lib/agent/**`, `next-app/lib/server/agent/**` | Changes to planner/execution/router/sub-agent flow; use only active plans listed in `docs/plans/README.md` |
