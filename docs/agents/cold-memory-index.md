...
| Cross-cutting testing strategy, test-scope decisions, and testing execution improvements | `docs/agents/testing-agent-contract.md`, `docs/plans/plan-testing-execution.md`, `docs/plans/plan-lint-governance.md`, `docs/reviews/repo-health.md` | Any request to decide what tests to add, evaluate regression-proof coverage, define test strategy, improve test command or CI execution, or review whether a change is well tested |
