...
Execution ergonomics, shared lane inventory, and CI-lane evolution are tracked separately in `docs/plans/plan-testing-execution.md` and `docs/runbooks/testing-ci-strategy.md`.
