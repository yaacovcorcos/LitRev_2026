...
- Shared chat-runtime direction exists for `/ai` and project copilot via the chat runtime plan; popup full runtime convergence remains pending (`U3` in `chatRuntime.md`).
