...
- Shared composer action hierarchy is active across chat surfaces:
  ...
  - The shared live progress bar now uses a composer-attached panel treatment with calmer motion, integrated count rail semantics, and host-owned seam/width alignment across `/ai`, main conversation, and side-panel copilot.
