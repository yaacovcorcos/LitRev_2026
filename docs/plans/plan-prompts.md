...
- [ ] Add optional structured "mentioned studies" response contract for assistant turns (machine-readable IDs/metadata for chat chip rendering), with graceful fallback when omitted.
