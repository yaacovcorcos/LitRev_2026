...
- `/ai`, project copilot, and popup performance work must preserve the shared runtime and truthful trace contracts owned by `docs/plans/plan-agentic.md`; use `docs/architecture/agentic-ui-glossary.md` when trace presentation vocabulary matters.
