...
- [**Agent Git Flow Candidate**](plan-git-flow.md): Candidate next-generation Git workflow design for agent branches, push/PR timing, structured closeout review, and multi-agent coordination. The active operational policy remains `docs/runbooks/github-flow.md` until this plan is explicitly promoted.
