...
3. `npm run test:e2e:mobile` passes with the behavior-level certification specs.
4. Existing `/ai` and stream reliability signals remain healthy under the current rollout.
5. No open P0/P1 responsive incidents remain on home/auth/project/protocol.
